...
## D052 selected earned Star titles and persistent Orb visual, DESIGN ONLY
Explorer Pathfinder / Opinion Magnet / Infinite Explorer; Sparkmaker First Mover / Scene Architect / final title TBD (Legendary Catalyst rejected); The Regular Familiar Face / Constant Star / Here to Stay. Stars and genuine stored +50/+300/+1500 milestone Aura remain independent of chosen featured/profile title. Aura Orb core branded v0.8 visuals evolve by real level/Aura, no score change from choosing styles or static brand app icon. See docs/2026-09-24_V08_RELEASE_SCOPE_LEDGER.md.
