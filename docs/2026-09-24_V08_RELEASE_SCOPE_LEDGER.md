...
## Founder decision D052 — titles and permanent Aura Orb
- The founder selected 8 of 9 Star-earned display titles, in exact order by path. Working path names remain Explorer, Sparkmaker and The Regular unless specifically renamed later.
  - Explorer: Star I **Pathfinder**; Star II **Opinion Magnet**; Star III **Infinite Explorer**.
  - Sparkmaker: Star I **First Mover**; Star II **Scene Architect**; Star III **TBD**, explicitly NOT **Legendary Catalyst**.
  - The Regular: Star I **Familiar Face**; Star II **Constant Star**; Star III **Here to Stay**.
- Eight title strings are founder-selected; final Sparkmaker Star III title and any localisation/casing still open. Do not overwrite titles with newer brainstorms. Separate path labels from earned-title labels and overall Aura LEVEL labels. Preserve per-path selected earned titles plus one featured earned profile title.
...
[ ] The selected 8 earned titles from D052, 9th Sparkmaker Star III TBD; earn and collect all actual titles, independently choose shown earned title per path and one featured earned profile title, keep names separate from Aura levels.
...
| 3-stars Drop Explorer, Dropsmith, Still Here 5/150/3000 etc | Explorer, Sparkmaker, The Regular with D044 numerical curves and D052 earned names | First v0.8; eight titles selected, Sparkmaker III pending |
...
1. Exact Sparkmaker Star III title replacement for “Legendary Catalyst” and final labels/path name casing. Candidate: Social Supernova; The Chain Reaction; Spark Sovereign; The Originator; Cosmic Instigator. None adopted until founder picks.
