...
3. docs/2026-09-24_V08_FOUNDER_DECISIONS.md — **five initial plus six further founder-confirmed v0.8 choices; D040–D046 (achievement targets/rewards, hybrid visual identity, 25+ level exploration, all earned Aura/badges preserved); supersedes ambiguous candidate language; DESIGN ONLY.**
