...
3. docs/2026-09-24_V08_FOUNDER_DECISIONS.md — **founder-confirmed v0.8 decisions D040–D053 (achievements, open-ended Aura chapters, rolling Crew Pulse and fully specified solo Charge mission criteria pending edge cases); supersedes ambiguous candidate language; DESIGN ONLY.**
...
5. docs/2026-09-25_OPTION_A_FIELD_TEST_AUDIT.md — Option A in progress: baseline, test assertion repair and founder mobile acceptance matrix.
6. docs/2026-09-24_FIELD_TEST_ACCEPTANCE.md — immediate observed bugs and field-test pass/fail.
